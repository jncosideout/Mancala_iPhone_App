...
//        let distFromTopToBoard = viewHeight - (runningYOffset + boardSideLength / 4)
        ...
        let playerWindowTopRight = InformationNode(plyWinTopText, size: playerWindowSize)
        ...
        let playerWindowBottomLeft = InformationNode(plyWinBottomText, size: playerWindowSize)
